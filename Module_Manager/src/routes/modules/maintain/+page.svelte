<script lang="ts">
  ...
  const maintainFeatures: MaintainFeature[] = [
    ...
    },
    {
      ...
      icon: '🔧',
      path: '/modules/maintain/preventive',
      status: 'coming-soon'
    },
    {
      ...
      icon: '🚨',
      path: '/modules/maintain/incidents',
      status: 'coming-soon'
    },
    {
      id: 'customer-support',
    ...
    },
    {
      ...
      icon: '📚',
      path: '/modules/maintain/knowledge',
      status: 'coming-soon'
    }
  ];
  ...
  <div class="maintain-module">
    ...
    <div class="module-content">
      ...
      <div class="overview-section">
        ...
        <p>The Maintain module provides comprehensive tools for managing customer support, preventive maintenance, incident response, and vendor coordination. Keep your network running smoothly with proactive maintenance and efficient issue resolution.</p>
      </div>
      ...
      <div class="features-section">
        ...
        <div class="features-grid">
          {#each maintainFeatures as feature}
            <div 
              class="feature-card" 
      ...
      <div class="quick-actions">
        ...
        <div class="actions-grid">
          ...
          <button class="action-btn" on:click={() => goto('/modules/maintain/incidents')}>
            <span class="action-icon">🚨</span>
            <span class="action-text">Incidents</span>
          </button>
          <button class="action-btn" on:click={() => goto('/modules/maintain/support')}>
            <span class="action-icon">👥</span>
