  ...
  <div class="modal-content" on:click|stopPropagation>
    ...
    <div class="modal-body">
      <div class="form-group">
        ...
        <input type="text" bind:value={formData.name} placeholder="Service Truck #1" required />
      </div>
      
      <div class="form-group">
        <label>Vehicle Number</label>
        <input type="text" bind:value={formData.vehicleNumber} placeholder="VEH-001" />
      </div>
      ...
      <div class="form-grid">
        <div class="form-group">
          ...
          <input type="text" bind:value={formData.driver} placeholder="John Doe" />
        </div>
        
        <div class="form-group">
          <label>Driver Phone</label>
          <input type="tel" bind:value={formData.driverPhone} placeholder="555-1234" />
        </div>
      </div>
      
      <div class="form-group">
        <label>Notes</label>
        <textarea bind:value={formData.notes} rows="2" placeholder="Mobile inventory location"></textarea>
      </div>
    </div>
...
<style>
  ...
  .modal-header { display: flex; justify-content: space-between; padding: 1.5rem; border-bottom: 1px solid var(--border-color); background: linear-gradient(135deg, #059669 0%, #10b981 100%); color: white; border-radius: 12px 12px 0 0; }
