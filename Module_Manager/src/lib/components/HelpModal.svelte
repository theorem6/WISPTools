...
{#if show}
  <div class="help-overlay" on:click={handleClose} on:keydown={(e) => e.key === 'Escape' && handleClose()}>
    <div class="help-modal" role="dialog" aria-modal="true" aria-labelledby="help-modal-title" on:click|stopPropagation on:keydown|stopPropagation>
