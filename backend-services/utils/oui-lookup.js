...
// Comprehensive OUI database for network equipment manufacturers
const COMMON_NETWORK_OUIS = {
  // Mikrotik (already checked separately, but included for completeness)
  '00:0C:42': 'Mikrotik',
  '4C:5E:0C': 'Mikrotik',
  'D4:CA:6D': 'Mikrotik',
  'E4:8D:8C': 'Mikrotik',
  ...
  '00:17:A2': 'Aruba Networks',
  '24:DE:C6': 'Aruba Networks',
  '70:3A:0E': 'Aruba Networks',
  '78:FE:3D': 'Aruba Networks',
  '90:72:40': 'Aruba Networks',
  'AC:47:33': 'Aruba Networks',
  'F0:9F:C2': 'Aruba Networks',
  
  // Ruckus Wireless (now CommScope)
  '00:17:C2': 'Ruckus Wireless',
  '00:1A:1E': 'Ruckus Wireless',
  '00:1D:AA': 'Ruckus Wireless',
  'A0:F3:C1': 'Ruckus Wireless',
...
/**
 * Detect manufacturers from ARP table by checking MAC addresses
 * @param {Array} arpTable - ARP table entries
 * @returns {Array} Array of detected devices with manufacturer info
 */
...
/**
 * Detect manufacturer from interfaces by checking MAC addresses
 * @param {Array} interfaces - Interface entries with MAC addresses
 * @returns {Object|null} Manufacturer info from first matching interface MAC, or null
 */
